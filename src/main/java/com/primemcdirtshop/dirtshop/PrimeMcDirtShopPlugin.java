...
import com.primemcdirtshop.dirtshop.listeners.ArmorySkillListener;
import com.primemcdirtshop.dirtshop.listeners.ShopMenuListener;
import com.primemcdirtshop.dirtshop.listeners.SkillProgressListener;
...
public class PrimeMcDirtShopPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        context.registerBean(ArmoryService.class, () -> new ArmoryService(this, getConfig()));
        ...
        context.registerBean(EconomyHealthService.class, () -> new EconomyHealthService(
                context.getBean(PlayerDataRepository.class),
                context.getBean(PluginConfiguration.class)
        ));
        context.registerBean(RegionService.class, () -> new RegionService(this, getConfig()));
        context.registerBean(PlayerStatsService.class, () -> new PlayerStatsService(
                this,
                getConfig(),
                context.getBean(ArmoryService.class)
        ));
        context.registerBean(MarketService.class, () -> new MarketService(
                ...
                context.getBean(PluginConfiguration.class),
                context.getBean(EconomyHealthService.class)
        ));
        ...
        context.registerBean(SkillProgressListener.class, () -> new SkillProgressListener(context.getBean(PlayerStatsService.class)));
        context.registerBean(ArmorySkillListener.class, () -> new ArmorySkillListener(
                context.getBean(ArmoryService.class),
                context.getBean(PlayerStatsService.class)
        ));
        ...
        context.getBean(RegionService.class).updateCommissions(context.getBean(EconomyHealthService.class).getShopkeeperTaxRate());
        Bukkit.getOnlinePlayers().forEach(player -> {
            ...
            context.getBean(PlayerStatsService.class).applyAttributes(player);
        });
    ...
    public void onDisable() {
        if (context != null) {
            ...
            context.getBean(PlayerStatsService.class).shutdown();
            context.close();
            context = null;
        }
    }
    ...
    private void registerListeners() {
        ...
        Bukkit.getPluginManager().registerEvents(context.getBean(SkillProgressListener.class), this);
        Bukkit.getPluginManager().registerEvents(context.getBean(ArmorySkillListener.class), this);
    }
